        ...
        <div class="col-md-12">
            <div class="box box-success box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Cumplimiento de Elegibilidad Legal</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-1">
                                @if($item->ele_estadolegal == 'PENDIENTE')
                                <img src="{{ asset('plugins/login/img/pdfPendiente.png') }}" alt="">
                                @elseif($item->ele_estadolegal == 'RECHAZADO')
                                <img src="{{ asset('plugins/login/img/pdfRechazado.png') }}" alt="">
                                @elseif($item->ele_estadolegal == 'ACEPTADO')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    @if($item->ele_legal || $item->ele_obslegal)
                                                        <a href="{{ $item->ele_legal }}" target="_blank"><img src="{{ asset('plugins/login/img/pdfpng.png') }}"/> C.E. Legal <em>({{ $item->ele_legal_nombre }})</em></a><br>
                                                        <div class="text-left">
                                                            <i class="fa fa-calendar"></i> <b>En fecha : </b><em>{{ fechaHora($item->ele_legactualiza) }}</em><br>
                                                            <i class="fa fa-user"></i> <b>Por : </b><em>{{ $item->userActualizaLegal->us_nombre.' '.$item->userActualizaLegal->us_paterno.' '.$item->userActualizaLegal->us_materno }}</em><br>
                                                            <b>Observaciones : </b><em>{{ $item->ele_obslegal }}</em>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <table class="pull-left">
                                                    <tr>
                                                        @if($item->ele_estadolegal == 'PENDIENTE' && $item->ele_legregistra == null)
                                                        <td style="padding-right:3px;">
                                                            @can('eleleg.create')
                                                                <a href="{{ route('eleleg.edit', $item->id) }}" class="btn btn-success btn-social"><i class="fa fa-check"></i> Aprobacíon Legal</a>
                                                            @endcan
                                                        </td>
                                                        @endif
                                                        <td style="padding-right:3px;">
                                                        ...
                                                        <td style="padding-right:3px;">
                                                            @can('eleleg.edit')
                                                                <a href="{{ route('eleleg.edit', $item->id) }}" class="btn btn-primary btn-social"><i class="fa fa-edit"></i> Editar</a>
                                                            @endcan
                                                        </td>
                                                        @endif
                                                    </tr>
