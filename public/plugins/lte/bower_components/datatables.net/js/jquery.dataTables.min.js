...
(function(h) {
    ...
    function ob(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<div class="form-group"><div class="input-group"><input type="search" class="form-control  ' + b.sFilterInput + '"/><div class="input-group-addon text-blue"><i class="fa fa-search"></i></div></div></div>',
            j = d.sSearch,
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfoFiltered: "(filtrado desde un total de _MAX_ entradas)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
