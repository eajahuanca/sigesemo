...
@section('titulopreview','Cargar documento de cumplimiento de elegibilidad técnica')
    ...
    <div class="row">
		<div class="col-md-12">
            <div class="box box-success box-solid">
                ...
                <div class="box-body">
                    <div class="content">
                    {{ Form::model($elegible, ['route' => ['eletec.update', $elegible->id], 'method' => 'PUT','files' => true, 'name' => 'frmDocumentos']) }}
                        @include('admin.elegible.tecnico.form')
                        ...
                        <div class="form-group text-center">
                            ...
                            <a href="{{ route('eletec.index') }}" class="btn btn-danger btn-social" name="btncancelar"><i class="fa fa-reply-all"></i> Cancelar</a>
                        </div>
                    {{ Form::close() }}
                    </div>
                </div>
